...
function Nominees() {
  ...
  if(nominatedMovies.length === 0) {
      return <h2 className="h-screen bg-gray-900 text-gray-100 flex items-center justify-center text-xl">No Movies has been nominated</h2>
  }

  return (
    <section className="bg-gray-900 text-gray-100">
      <h2 className="lg:text-2xl text-base text-red-600 lg:py-4 lg:px-28 md:p-18 p-4">Nominations List</h2>
